...
# in lowercase format
lowercase_full_names = [name.split()[0][0].lower() + name.split()[0][1:] + " " + name.split()[1][0].lower() +
                        name.split()[1][1:] for name in full_names]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# TODO: use a list comprehension to create a list of integers
# from the above list of strings
numbers = [int(number.split()[0]) for number in almost_numbers]
print(numbers)
